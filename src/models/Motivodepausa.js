...
const Motivodepausa = sequelize.define('Motivodepausa', {
  id: {
...
export default Motivodepausa; // Certifique-se de que o modelo está sendo exportado como default
